    ...
    <div className="flex justify-between items-center">
      <div className="w-full md:w-1/2 mt-8 md:mt-0">
        ...
        <form onSubmit={submit} className="flex">
          ...
          />
          <button className="bg-orange-500 hover:bg-orange-600 transition-all duration-200 focus:outline-none shadow-inner text-white px-4 md:px-6 py-3 whitespace-nowrap">
            Daftar Now
          </button>
        </form>
      </div>
