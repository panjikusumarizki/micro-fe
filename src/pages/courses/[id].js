      ...
      <section className="container mx-auto pt-24 relative">
        ...
        <div>
          <CSSTransition
            ...
            unmountOnExit
          >
            <div className="meta-price w-full bg-white z-50 left-0 md:py-3">
              <div className="w-full md:w-3/4 md:mx-auto">
                <div className="flex items-center">
                  ...
                  <a
                    ...
                    className="bg-orange-500 hover:bg-orange-600 transition-all duration-200 focus:outline-none shadow-inner text-white px-6 py-3 whitespace-nowrap"
                  >
        ...
        <div className="w-3/4 mx-auto mt-8">
          <div className="w-full md:w-3/4">
            ...
            <section className="mt-10 w-full md:w-8/12">
              <h6 className="font-medium text-gray-900 text-2xl mb-4">
